...
class DataProcessor(threading.Thread):
    ...
    def feature_callback(self, obj, task_uri):
        ...
        """
        self.logger.info(f"######### to be done, feature_callback obj: {obj}, task_uri: {task_uri}")
        ...
        try:
            self.logger.info(f"######### to be done, start to processing feature data for instruments {instruments}, start_time: {start_time}, end_time: {end_time}")
            uri = D.features_uri(
